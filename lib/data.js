...
export const focusAreas = [
  {
    ...
    description:
      "We support learning initiatives, scholarships, and skill development to ensure equal access to education.",
    icon: "GraduationCap",
    img: "/img/contents/programs-education-2.webp",
  },
  {
    key: "economic",
    ...
    description:
      "We help develop small businesses and entrepreneurship through training, mentoring, and financial access.",
    icon: "ChartNoAxesCombined",
    img: "/img/contents/programs-economic.webp",
  },
  {
    key: "health",
    title: "Health",
    ...
    description:
      "We implement healthcare programs, sanitation campaigns, and nutritional support for underprivileged communities.",
    icon: "Stethoscope",
    img: "/img/contents/programs-health.webp",
  },
  {
    key: "environment",
    title: "Environment",
    ...
    description:
      "We promote conservation efforts, reforestation, and eco-friendly initiatives to protect our planet.",
    icon: "Sprout",
    img: "/img/contents/programs-environment.webp",
  },
  {
    key: "social-and-culture",
    title: "Social & Culture",
    subtitle: "Preserving traditions, fostering inclusion",
    description:
      "We support cultural heritage programs and inclusive social initiatives for stronger communities.",
    icon: "Drama",
    img: "/img/contents/programs-social-culture.webp",
  },
];
