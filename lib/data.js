...
export const pentahelixItems = [
  {
    key: "government",
    title: "Pemerintah (Government)",
    subtitle: "Pembuat Kebijakan & Regulasi",
    description:
      "Pemerintah berperan sebagai fasilitator utama dalam mewujudkan impact melalui kebijakan, regulasi, dan dukungan infrastruktur.",
    roles: [
      "Menyediakan regulasi yang mendukung keberlanjutan program sosial dan lingkungan.",
      "Membangun insentif bagi sektor swasta untuk terlibat dalam program CSR dan keberlanjutan.",
      "Menyediakan pendanaan dan program bantuan untuk inisiatif yang berdampak luas.",
      "Mengintegrasikan program-program berbasis impact ke dalam kebijakan daerah dan nasional.",
    ],
    icon: Landmark,
    img: "/img/contents/penta-government",
  },
  {
    key: "academia",
    title: "Akademisi (Academia)",
    subtitle: "Sumber Ilmu & Inovasi",
    description:
      "Akademisi berperan dalam menyediakan riset, inovasi, dan teknologi untuk mendukung implementasi program berbasis impact.",
    roles: [
      "Menyediakan penelitian berbasis data sebagai dasar perumusan kebijakan dan program.",
      "Mengembangkan teknologi dan inovasi untuk membantu bisnis dan komunitas menciptakan dampak lebih besar.",
      "Memberikan pendidikan dan pelatihan bagi masyarakat agar dapat beradaptasi dengan perubahan.",
      "Menganalisis efektivitas program yang telah dijalankan untuk perbaikan berkelanjutan.",
    ],
    icon: GraduationCap,
    img: "/img/contents/penta-academia",
  },
  {
    key: "business",
    title: "Bisnis (Business)",
    subtitle: "Penggerak Ekonomi & Inisiator CSR",
    description:
      "Sektor bisnis memainkan peran penting dalam penyediaan sumber daya, investasi sosial, dan praktik berkelanjutan.",
    roles: [
      "Menerapkan CSR yang berorientasi pada impact jangka panjang, bukan sekadar kewajiban.",
      "Mengembangkan model bisnis berkelanjutan yang tidak hanya mencari profit tetapi juga menciptakan dampak sosial dan lingkungan.",
      "Berinvestasi dalam inovasi dan teknologi yang dapat meningkatkan kesejahteraan masyarakat.",
      "Bermitra dengan komunitas untuk menciptakan lapangan kerja dan pemberdayaan ekonomi.",
    ],
    icon: BriefcaseBusiness,
    img: "/img/contents/penta-business",
  },
  {
    key: "community",
    title: "Masyarakat atau Komunitas (Community)",
    subtitle: "Subjek & Penggerak Perubahan",
    description:
      "Masyarakat adalah penerima manfaat utama dari impact dan sekaligus dapat menjadi penggerak utama dalam keberlanjutan program.",
    roles: [
      "Menjadi bagian aktif dalam perencanaan dan implementasi program berbasis impact.",
      "Mendorong perubahan dari tingkat akar rumput (grassroots movement).",
      "Berpartisipasi dalam edukasi, advokasi, dan inisiatif keberlanjutan.",
      "Mengelola dampak yang telah diciptakan agar tetap berjalan dalam jangka panjang.",
    ],
    icon: HeartHandshake,
    img: "/img/contents/penta-community",
  },
  {
    key: "media",
    title: "Media",
    subtitle: "Penyebar Informasi & Advokasi Publik",
    description:
      "Media berperan dalam menyampaikan informasi, membangun kesadaran, dan mengawal akuntabilitas program berbasis impact.",
    roles: [
      "Menyebarluaskan kisah sukses dan best practices dari program impact.",
      "Meningkatkan kesadaran publik tentang pentingnya keberlanjutan dan pembangunan sosial.",
      "Mengawal transparansi dan akuntabilitas pemerintah, bisnis, dan komunitas dalam menjalankan program impact.",
      "Mendorong advokasi dan perubahan kebijakan berbasis kebutuhan masyarakat.",
    ],
    icon: TvMinimalPlay,
    img: "/img/contents/penta-media",
  },
];
